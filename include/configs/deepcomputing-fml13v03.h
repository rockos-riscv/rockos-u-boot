...
#define CFG_EXTRA_ENV_SETTINGS \
    ...
    "boot_targets=usb mmc1 mmc0 nvme\0" \

#undef CONFIG_BOOTCOMMAND
#define CONFIG_BOOTCOMMAND \
    "if env exists updated; then exit;fi;fdt rm /reserved-memory/mmode_resv1@10,0;bootflow scan -b;setenv stdout serial,vidconsole;cls;echo No boot medium found!"
